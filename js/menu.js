...
var menuObjects = {
	user: function(e){
		...
		return {
				...
				"OP Action": { subMenu: {
					[e]: { title: true },
					"Give OP": { callback: function(e){ alert("menu click"); } },
					"Remove OP": { callback: function(e){ alert("menu click"); } },
					"Give Voice": { callback: function(e){ alert("menu click"); } },
					"Remove Voice": { callback: function(e){ alert("menu click"); } }
				}}
			}
	}
}
